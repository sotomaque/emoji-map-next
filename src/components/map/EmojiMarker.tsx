...
const EmojiMarker = memo(function EmojiMarker({
  position,
  emoji,
  onClick,
  isNew = false,
  ...
  useEffect(() => {
    if (isFirstRender.current) {
      console.log(`[EmojiMarker] Initial render of ${emoji} marker, isNew: ${isNew}, delay: ${delay}ms`);
      ...
      if (positionChanged) {
        ...
        console.log(`[EmojiMarker] Re-render of ${emoji} marker (no position change)`);
      }
    }
  });
