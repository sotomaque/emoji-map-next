    ...
    <div className='w-full h-full flex items-center justify-center'>
      <div className='flex items-center space-x-2 px-2 py-1'>
        ...
        >
          <div className='flex items-center space-x-1 px-2 py-1'>
            ...
            <motion.button
              ...
              disabled={isLoading}
              className={`flex items-center justify-center min-w-[44px] h-11 rounded-full ${
                isAllCategoriesMode
        ...
        <motion.button
          ...
          disabled={isLoading}
          className={`flex items-center justify-center w-12 h-12 rounded-full shadow-md bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 ${
            isLoading
