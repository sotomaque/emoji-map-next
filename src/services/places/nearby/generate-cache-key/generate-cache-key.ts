 ...
 * - Valid cache keys will be in the format 'places:${version}:{latitude},{longitude}'
 */
export function generateCacheKey({
  ...
  return `${NEARBY_CONFIG.CACHE_KEY}:${NEARBY_CONFIG.CACHE_KEY_VERSION}:${normalizedLocation}`;
}
