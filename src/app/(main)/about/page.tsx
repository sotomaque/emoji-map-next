        ...
        <div className='prose dark:prose-invert max-w-none'>
          <section className='mb-12'>
            ...
            <p>
              ...
              of places they&apos;re looking for, regardless of what language
              they speak.
            </p>
            <p className='mt-4'>
              Whether you&apos;re looking for a coffee shop (☕), a restaurant
              (🍽️), or a park (🌳), Emoji Map helps you find what you need with
              a glance at the map.
            </p>
          </section>
          ...
          <section className='mb-12'>
            ...
            <div className='grid md:grid-cols-3 gap-8 mt-6'>
              <div className='bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm p-6 rounded-lg shadow-sm border border-purple-100 dark:border-white/5'>
          ...
          <section className='mb-12'>
            ...
            <p>
              Emoji Map is an open-source project available on multiple
              platforms. We believe in transparency and community collaboration.
              You can find our source code on GitHub and contribute to either
              the web or iOS version of the project.
            </p>
            <div className='mt-6 flex flex-col sm:flex-row gap-4'>
              ...
              <Link
                ...
                target='_blank'
                rel='noopener noreferrer'
                className='inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105'
              >
                <svg
                  className='w-5 h-5 mr-2'
                  viewBox='0 0 24 24'
