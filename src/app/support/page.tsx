...
export default function SupportPage() {
  ...
  return (
    <div className='container max-w-6xl mx-auto py-12 px-4 sm:px-6 relative'>
      {/* Emoji background decorations */}
      <div className='absolute top-20 left-10 text-4xl opacity-10 animate-bounce-slow hidden md:block'>
        🗺️
      </div>
      <div className='absolute top-40 right-20 text-4xl opacity-10 animate-pulse hidden md:block'>
        🧭
      </div>
      <div className='absolute bottom-40 left-20 text-4xl opacity-10 animate-pulse hidden md:block'>
        📍
      </div>
      <div className='absolute bottom-60 right-10 text-4xl opacity-10 animate-bounce-slow hidden md:block'>
        🔍
      </div>
