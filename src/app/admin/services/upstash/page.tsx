...
import { UPSTASH_CONSOLE } from '@/constants/links';

export default function UpstashPage() {
  return (
    <div className='flex flex-1 flex-col gap-6 p-6'>
      <div className='space-y-2'>
        <h1 className='text-3xl font-bold tracking-tight'>Upstash</h1>
        <p className='text-muted-foreground max-w-3xl'>
          EmojiMap uses Upstash for serverless Redis.
        </p>
      </div>
        ...
        <div className='bg-card border rounded-lg shadow-sm p-8 max-w-md w-full'>
          <div className='space-y-6'>
            ...
            <div className='text-center space-y-2'>
              <h2 className='text-2xl font-semibold'>Upstash Management</h2>
              <p className='text-muted-foreground'>
                Access Upstash console or request additional permissions
              </p>
            </div>
